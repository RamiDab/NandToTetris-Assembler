...
class SymbolTable:
    ...
    def __init__(self) -> None:
        ...
        """
        # Your code goes here!
        self.thetable = [['R0', 0], ['R1', 1], ['R2', 2], ['R3', 3], ['R4', 4], ['R5', 5], ['R6', 6], ['R7', 7],
    ...
    def add_entry(self, symbol: str, address: int) -> None:
        ...
        """
        # Your code goes here!
        self.thetable.append([symbol, address])
    ...
    def contains(self, symbol: str) -> bool:
        ...
        """
        # Your code goes here!
        for i in range(len(self.thetable)):
            if(self.thetable[i][0] == symbol):
                    return True
        return False
